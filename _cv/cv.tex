...
\email{francois.fevotte@triscale-innov.com}
...
\cventry{depuis 2019}{Co-fondateur \& Directeur Scientifique}{TriScale innov}{}{}{}
...
\cventry{2008--2019}{Ingénieur Chercheur}{EDF R\&D, dept PERICLES, groupe Analyse et
  Modèles Numériques}{}{}{
  \begin{description}
...
\OSproject{Verrou}{C (9k lignes)}{24}{7}{%
...
\OSproject{clang-tags}{C++ (4k lignes)}{104}{23}{%
...
\OSproject{AccurateArithmetic.jl}{Julia (2k lignes)}{25}{5}{\quad%
  Implémentation performante d'algorithmes compensés vectorisés en langage Julia.
  \begin{itemize}
  \item Développeur principal
  \item Performance comparable à OpenBLAS pour la somme et le produit scalaire
    sur architectures AVX-2 \& AVX-512
  \item \url{https://github.com/JuliaMath/AccurateArithmetic.jl}
  \end{itemize}
}

% \OSproject{desktop-plus}{Lisp (1k lignes)}{48}{10}{%
...
\OSproject{GFlops.jl}{Julia (1k lignes)}{35}{3}{%
  Outil de benchmarking permettant de déterminer la performance absolue de codes Julia.
  \begin{itemize}
  \item Développeur principal
  \item \url{https://github.com/triscale-innov/GFlops.jl}
  \end{itemize}
}
...
\project{Micado}{C++ (11k lignes)}{%
  ...
  \item Parallélisme à 3 niveaux : mémoire distribuée (MPI) \& partagée (tbb),
    SIMD (Eigen)
  \end{itemize}
}
